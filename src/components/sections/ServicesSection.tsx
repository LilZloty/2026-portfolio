        ...
        >
          {currentServices.map((service) => (
            ...
            >
              ...
              {'ctaLink' in service ? (
                <a
                  href={service.ctaLink as string}
                  className={service.highlight ? 'btn-primary w-full text-center' : 'btn-secondary w-full text-center'}
                >
                  {'ctaText' in service ? service.ctaText as string : 'Get Started'}
                </a>
              ) : (
                <button
