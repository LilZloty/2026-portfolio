  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto">
        ...
        {/* Results Counter */}
        <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 mb-14 py-6 border-y border-silver-800">
          <div className="text-center">
            <p className="text-3xl md:text-4xl font-mono font-bold text-lime-neon">70+</p>
            <p className="text-xs text-silver-500 uppercase tracking-wider mt-1">Stores Optimized</p>
          </div>
          <div className="text-center">
            <p className="text-3xl md:text-4xl font-mono font-bold text-white">92</p>
            <p className="text-xs text-silver-500 uppercase tracking-wider mt-1">Avg. PageSpeed</p>
          </div>
          <div className="text-center">
            <p className="text-3xl md:text-4xl font-mono font-bold text-white">+25%</p>
            <p className="text-xs text-silver-500 uppercase tracking-wider mt-1">Avg. Speed Increase</p>
          </div>
          <div className="text-center">
            <p className="text-3xl md:text-4xl font-mono font-bold text-white">7</p>
            <p className="text-xs text-silver-500 uppercase tracking-wider mt-1">Years Experience</p>
          </div>
        </div>
